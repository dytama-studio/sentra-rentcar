...
const FooterLanding = () => {
  return (
    <footer className="relative overflow-hidden  bg-gradient-to-b from-[#1B004D] to-[#2E0A6F] pt-10">
      <Container className="text-sm text-gray-50">
          ...
          <div>
            <div className="flex flex-col lg:items-start lg:justify-center gap-5">
              ...
              <div className="inline-flex items-center gap-2">
                ...
                <p className="text-md font-semibold text-white">
                  example.email@sentrarent.co.id
                </p>
              </div>
              <div className="inline-flex items-center gap-2">
