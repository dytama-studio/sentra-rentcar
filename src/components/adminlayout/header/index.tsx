...
const HeaderAdmin = ({ sidebarOpen, setSidebarOpen, user }: Props) => {
  return (
    <header className="sticky top-0 z-50 flex w-full bg-white dark:bg-boxdark dark:drop-shadow-none border-b broder-gray-200">
      <div className="flex flex-grow items-center justify-between px-4 py-2 md:px-4 2xl:px-5">
